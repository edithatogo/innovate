...
## Phase 1 Checkpoint: [checkpoint: pending] Report Contract and Claim Taxonomy
...
## Phase 2 Checkpoint: [checkpoint: pending] Sensitivity and Explainability APIs
...
## Phase 3 Checkpoint: [checkpoint: pending] Reports, Docs, and Evidence
