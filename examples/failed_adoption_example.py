...
def run_failed_adoption_example():
    ...
    # failed_products_indices = analyze_failure(
    #     market_share_predictions, failure_threshold=failure_threshold
    # )
    ...
    #         plt.axhline(
    #             y=m_vals[i] * failure_threshold,
    #             color="r",
    #             linestyle="--",
    #             alpha=0.7,
    #             label=f"Failure Threshold ({name})"
    #             if i == failed_products_indices[0]
    #             else "",
    #         )
    #         plt.text(
    #             time_horizon[-1] * 0.8,
    #             m_vals[i] * failure_threshold * 1.1,
    #             "FAILED",
    #             color="red",
    #             fontsize=10,
    #             ha="center",
