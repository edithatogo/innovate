...
def run_path_dependence_example():
    ...
    params = {
        "alpha1": 0.1, "alpha2": 0.1,  # Intrinsic growth rates
        "beta1": 0.02, "beta2": 0.01,  # Network effect strengths (Tech 1 stronger)
        "gamma1": 0.005, "gamma2": 0.005, # Negative influence of competitor
    ...
    axes[0].plot(t, predictions_s1[:, 1], label='Technology 2', color='red', linestyle='--')
    axes[0].set_title(f'Scenario 1: Initial (Tech 1={y0_scenario1[0]}, Tech 2={y0_scenario1[1]})')
    ...
    axes[1].plot(t, predictions_s2[:, 1], label='Technology 2', color='red', linestyle='--')
    axes[1].set_title(f'Scenario 2: Initial (Tech 1={y0_scenario2[0]}, Tech 2={y0_scenario2[1]})')
    ...
    axes[2].plot(t, predictions_s3[:, 1], label='Technology 2', color='red', linestyle='--')
    axes[2].set_title(f'Scenario 3: Initial (Tech 1={y0_scenario3[0]}, Tech 2={y0_scenario3[1]})')
