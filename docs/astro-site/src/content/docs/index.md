...
| Topic | Link |
|-------|------|
| Installation guide | [Getting Started](/user-guide/getting-started/) |
| Core concepts | [Kernel Overview](/core/kernel/) |
| Full API reference | [Python API](/api/python/) |
| Migration from Sphinx | [Migration Guide](/migration/) |
