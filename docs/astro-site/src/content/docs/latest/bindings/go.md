---
title: Go Bindings
description: Go module adapter over the shared kernel contract.
---
...
The Go package keeps its schema version aligned with the Python kernel contract.
...
- The package is consumed as a Go module using the import path
  `github.com/edithatogo/innovate/bindings/go` and versioned submodule tags such
  as `bindings/go/v0.5.0`.
