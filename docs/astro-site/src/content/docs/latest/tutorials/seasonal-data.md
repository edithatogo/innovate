---
title: Handling Seasonal Data with Diffusion Models
description: Decomposing time series to isolate diffusion trends from seasonal patterns.
---
...
## A simple example: fitting a logistic model to seasonal data
