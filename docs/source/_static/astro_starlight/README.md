...
- `migration_manifest.json` — cutover policy and pinned baseline
- `content_inventory.json` — canonical docs pages and planned Astro routes
- `redirect_inventory.json` — forwarder plan that preserves legacy Sphinx URLs
  as compatibility aliases after cutover
