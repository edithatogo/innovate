...
SIDEBAR_ROUTES = [
    ...
    "/operations/community-readiness/",
    "/operations/accelerator-parallel-execution/",
    "/operations/abi-compatibility/",
    "/operations/governance/",
    "/operations/hpc-registry/",
    "/operations/hpc-readiness/",
    "/operations/hpc-submission-packet/",
    "/operations/hpc-submission-workflow/",
    "/operations/polyglot-registry/",
    "/operations/remote-execution/",
    "/operations/registry-submissions/",
    "/operations/scientific-hpc/",
    "/operations/submission-dossiers/",
    "/operations/xla-backend/",
    "/maintainers/publication/",
    "/maintainers/release-notes/",
    "/maintainers/plugins/",
    "/maintainers/stability/",
    "/maintainers/runtime-logging/",
    "/architecture/",
    "/architecture/adr/",
    "/architecture/polyglot-repo/",
    "/operations/roadmap/",
    "/roadmap/diagnostics-uncertainty/",
    "/roadmap/probabilistic-inference/",
    "/roadmap/dataframe-engine/",
    "/migration/",
    "/migration/redirects/",
