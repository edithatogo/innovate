...
ROADMAP_PATH = Path("docs/astro-site/src/content/docs/operations/rust-core.md")
...
def test_rust_migration_inventory_is_execution_grade_backlog() -> None:
    ...
    assert (
        phase_by_key[("all_kernel_operations", "probabilistic_runtimes_uncertainty_and_python_object_internals")]
