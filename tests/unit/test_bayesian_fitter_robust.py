...
class TestBayesianFitterRobust:
    ...
    def test_basic_fitting(self):
        ...
        # Fit model
        model = BassModel()
        fitter = BayesianFitter(num_chains=2, num_warmup=100, num_samples=100)
    ...
    def test_parameter_estimation_methods(self):
        ...
        model = BassModel()
        fitter = BayesianFitter(num_chains=2, num_warmup=50, num_samples=50)
        fitter.fit(model, t, y)
    ...
    def test_small_dataset(self):
        ...
        model = BassModel()
        fitter = BayesianFitter(num_chains=1, num_warmup=20, num_samples=20)
    ...
    def test_reproducibility(self):
        ...
        model1 = BassModel()
        fitter1 = BayesianFitter(num_chains=1, num_warmup=30, num_samples=30, random_seed=42)
        fitter1.fit(model1, t, y)
        estimates1 = fitter1.get_parameter_estimates()

        model2 = BassModel()
        fitter2 = BayesianFitter(num_chains=1, num_warmup=30, num_samples=30, random_seed=42)
